...
## Brief Introduction
This project is driven by the frequent and widespread errors in raw rating scores generated by LLMs—errors that can vary significantly across different models. Then, the score errors can be visualized by a score transition matrix (A larger value on the matrix’s diagonal indicates that the score error is smaller)
