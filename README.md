...
## Brief Introduction
This project is driven by the frequent and widespread errors in raw rating scores generated by LLMs—errors that can vary significantly across different models. In response, we introduce **DS2**, a diversity-aware score curation approach designed to enhance data selection.
