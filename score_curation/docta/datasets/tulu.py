...
class TULU_RLHF(CustomizedDataset):
    def __init__(self, cfg, args, train=True):
        ...
        # label_path  =  cfg.data_root + f'model_finetune_cluster/new_train_data/{args.labeling_model}/{args.dataset_name}/output_labels_revised.pt'
        # label_path  =  cfg.data_root + f'new_train_data/{args.labeling_model}/{args.dataset_name}/clean_output_labels.pt' for clean evaluation
