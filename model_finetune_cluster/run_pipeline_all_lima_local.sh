...
base_models["meta-llama/Meta-Llama-3.1-8B"]="128 1 2048"
...
### llama labeling
confidence_prob=0.4
data_types=("filtered-cured-${confidence_prob}-1k") #
...
cluster_root_path="../finetune_lima_result" ## . for local
...
#             if [[ $data_type == "lima" ]]; then
#                 echo "training data:: lima"
#                 train_data="new_train_data/lima_dataset.json"
#             else
...
for base_model in "${!base_models[@]}"; do
    ...
    for train_dataset_name in "${TRAIN_DATASET_LIST[@]}"; do
        ...
        for data_type in "${data_types[@]}"; do
            ...
            # CUDA_VISIBLE_DEVICES=3 python -m eval.tydiqa.run_eval \
...
# azcopy copy  "https://afminternshipuksouth.blob.core.windows.net/jinlong/finetune_70B_result/?sp=racwdlmeop&st=2024-08-16T20:24:00Z&se=2025-03-07T05:24:00Z&sv=2022-11-02&sr=c&sig=%2F3S088nsqvxn%2BtRGen7utkkxJHxgQ5NwlSQlWufI390%3D" . --recursive
