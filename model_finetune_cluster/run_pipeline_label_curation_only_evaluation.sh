...
data_types=("label-filtered-cured-${confidence_prob}" "diversity-filtered-cured-${confidence_prob}") #baselines
    ...
    for train_dataset_name in "${TRAIN_DATASET_LIST[@]}"; do
        ...
        for data_type in "${data_types[@]}"; do
            ...
            if [[ $data_type == "base" ]]; then
                ...
                AZURE_STORAGE_CONTAINER_URL="https://afminternshipuksouth.blob.core.windows.net/jinlong/curation_result/${store_model_name_or_path}/?sp=racwdlmeop&st=2024-08-24T00:58:39Z&se=2025-04-03T08:58:39Z&sv=2022-11-02&sr=c&sig=rbf41XiVlLJw76zeillA%2FRMAjgGMo2lQHO3m3RW5Ho8%3D"
