...
data_types=('random_3') #baselines

# data_types=('filtered_4') #baselines
...
do
    ...
    do
        ...
        accelerate launch \
            ...
            --weight_decay 0. \
            --num_train_epochs 5 \
            --output_dir models/${labeling_model}/${train_dataset_name}/${base_model}/lora_${data_type}/ \
            --with_tracking \
        ...
        python open_instruct/merge_lora.py \
            ...
            --lora_model_name_or_path models/${labeling_model}/${train_dataset_name}/${base_model}/lora_${data_type}/ \
            --output_dir models/${labeling_model}/${train_dataset_name}/${base_model}/lora_merged_${data_type}/ \
            --save_tokenizer
...
for train_dataset_name in "${TRAIN_DATASET_LIST[@]}"; do
    ...
    for data_type in "${data_types[@]}"; do
        ...
        model_name_or_path=models/${labeling_model}/${train_dataset_name}/${base_model}/lora_merged_${data_type}
        ...
        local_save_dir=results/${labeling_model}/${train_dataset_name}/${eval_dataset_name}/${base_model}/$data_type
...
do
    ...
    python3 read_results.py --train_dataset $train_dataset_name --base_model $base_model --labeling_model $labeling_model --baseline_tag $data_type
