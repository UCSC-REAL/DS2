...
# data_types=('random-2k' 'random-5k' 'random-10k' 'random-20k' 'random-40k') #baselines

# data_types=('less-2k' 'less-5k' 'less-10k' 'less-20k' 'less-40k') #baselines

###################################
#### label-aware method

# data_types=('label-filtered-2k' 'label-filtered-5k' 'label-filtered-10k' 'label-filtered-20k' 'label-filtered-40k')

# data_types=('diversity-filtered-2k' 'diversity-filtered-5k' 'diversity-filtered-10k' 'diversity-filtered-20k' 'diversity-filtered-40k')

# data_types=('filtered-2k' 'filtered-5k' 'filtered-10k' 'filtered-20k' 'filtered-40k') #baselines

# confidence_prob=0.5
# data_types=("filtered-cured-${confidence_prob}-2k" "filtered-cured-${confidence_prob}-5k"  "filtered-cured-${confidence_prob}-10k" "filtered-cured-${confidence_prob}-20k" "filtered-cured-${confidence_prob}-40k") #baselines

data_types=('label-filtered-2k')
...
AZURE_STORAGE_CONTAINER_URL="https://afminternshipuksouth.blob.core.windows.net/jinlong/data_scale_result_seed${SEED}/?sp=racwdlmeop&st=2024-08-24T00:58:39Z&se=2025-04-03T08:58:39Z&sv=2022-11-02&sr=c&sig=rbf41XiVlLJw76zeillA%2FRMAjgGMo2lQHO3m3RW5Ho8%3D"
...
AZURE_STORAGE_CONTAINER_URL="https://afminternshipuksouth.blob.core.windows.net/jinlong/data_scale_result_seed${SEED}/results/?sp=racwdlmeop&st=2024-08-24T00:58:39Z&se=2025-04-03T08:58:39Z&sv=2022-11-02&sr=c&sig=rbf41XiVlLJw76zeillA%2FRMAjgGMo2lQHO3m3RW5Ho8%3D"
