...
# data_types=('random-2k' 'random-5k' 'random-20k' 'random-40k') #baselines
...
# data_types=('less-2k' 'less-5k' 'less-20k' 'less-40k') #baselines
...
# AZURE_STORAGE_CONTAINER_URL="https://afminternshipuksouth.blob.core.windows.net/jinlong/data_scale_result/?sp=racwdlmeop&st=2024-08-24T00:58:39Z&se=2025-04-03T08:58:39Z&sv=2022-11-02&sr=c&sig=rbf41XiVlLJw76zeillA%2FRMAjgGMo2lQHO3m3RW5Ho8%3D"
    ...
    for train_dataset_name in "${TRAIN_DATASET_LIST[@]}"; do
        ...
        for data_type in "${data_types[@]}"; do
            ...
            if [[ $data_type == "base" ]]; then
                ...
                AZURE_STORAGE_CONTAINER_URL="https://afminternshipuksouth.blob.core.windows.net/jinlong/${cluster_root_path}/${store_model_name_or_path}/?sp=racwdlmeop&st=2024-08-24T00:58:39Z&se=2025-04-03T08:58:39Z&sv=2022-11-02&sr=c&sig=rbf41XiVlLJw76zeillA%2FRMAjgGMo2lQHO3m3RW5Ho8%3D"
